...
frappe.ui.form.on("Interview", {
	...
	feedback: function (frm) {
        frappe.call({
            method: "sequertek.sequertek.override_function.interview.get_assessment_details",
            args: {
                parenttype: "Interview Feedback Template",
                parent: "Basic Feedback Template",
                parentfield_s: JSON.stringify(["behavioral", "attributes", "technical"]),
                
            },
            callback: function (r) {
                console.log("Custom submit_feedback logic executed.");
                console.log(r);
	...
	show_feedback_dialog: function (frm, data) {
        ...
        console.log(data.skill_assessment,"hello")
        ...
        let d = new frappe.ui.Dialog({
            ...
            fields: [
                {
                    ...
                    fieldtype: "Table",
                    label: __("Behavioral Assessment"),
                ...
                },
                {
                    ...
                    fieldtype: "Table",
                    label: __("Attributes Assessment"),
                    cannot_add_rows: false,
                    in_editable_grid: true,
                    reqd: 1,
                    fields: fields,
                ...
                // {
                //     fieldname: "sales_rep_success_areas",
                //     fieldtype: "Table",
                //     label: __("Sales Rep Success Areas"),
                //     cannot_add_rows: false,
                //     in_editable_grid: true,
                //     reqd: 1,  
                //     fields: fields,
                //     data: data.skill_assessment,  
                // },
                {
                    fieldname: "result",
                    fieldtype: "Select",
                ...
                },
				{
					...
					fieldtype: "Small Text",
					label: __("Key Strengths of the Candidate"),
					
				},
				{
					fieldname: "key_areas",
					fieldtype: "Small Text",
					label: __("Key Areas of Focus/Improvement"),
            ...
            primary_action: function (values) {
				console.log("Key Strengths submitted:", values.key_strengths);
				console.log("Key Areas submitted:", values.key_areas);
                
                frappe.call({
                    method: "sequertek.sequertek.override_function.interview.create_interview_feedback",  // Updated path
                    args: {
                        data: values,
